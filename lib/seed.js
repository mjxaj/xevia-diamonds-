...
const DEFAULT_SETTINGS = {
  ...
  site_established: process.env.SITE_ESTABLISHED || '2026',
  site_founder: process.env.SITE_FOUNDER || 'Kashish Goyal',
  ...
  contact_address: process.env.CONTACT_ADDRESS || 'Raipur, India',
  ...
  about_body:
    'Xevia Diamonds is a Raipur-rooted atelier creating contemporary fine jewellery in 14K and 18K gold, set with ethically sourced natural diamonds and rare gemstones. Founded in 2026 by Kashish Goyal, every piece is hand-finished by master artisans whose craft has been passed down across generations.',
